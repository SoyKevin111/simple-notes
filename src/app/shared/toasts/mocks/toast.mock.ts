...
export const dataToast: Toast[] = [
	...
	{ type: 'deleteTask', data: 'name-card has been deleted.', path: 'assets/img/icon/icon-toast-svg/icon-toast-export.svg', primarycolor: '' },
	{ type: 'completeTask', data: 'The name-card has been completed.', path: 'assets/img/icon/icon-toast-svg/icon-toast-export.svg', primarycolor: '' }
];